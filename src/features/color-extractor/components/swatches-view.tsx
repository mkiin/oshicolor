...
const SwatchCard: React.FC<SwatchCardProps> = ({ role, swatch }) => (
  ...
  >
    ...
    {swatch ? (
      <p className="text-[10px] font-mono mt-1" style={{ color: swatch.bodyTextColor.hex() }}>
        {swatch.color.hex()}
      </p>
    ) : (
...
export const SwatchesView: React.FC<SwatchesViewProps> = ({ swatches }) => (
  <div className="space-y-2">
    <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-widest">Swatches</h2>
