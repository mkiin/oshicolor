/* @ts-self-types="./oshicolor_wasm.d.ts" */
 ...
 * @returns {any}
 */
export function genColorsFromBytes(bytes, config) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.genColorsFromBytes(ptr0, len0, config);
    if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('oshicolor_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
